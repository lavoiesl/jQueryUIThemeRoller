...
$textures = array(
        array("value"=>"01_flat.png","width"=>"40","height"=>"100","name"=>"flat"),
        array("value"=>"02_glass.png","width"=>"1","height"=>"400","name"=>"glass"),
        array("value"=>"03_highlight_soft.png","width"=>"1","height"=>"100","name"=>"highlight soft"),
        array("value"=>"04_highlight_hard.png","width"=>"1","height"=>"100","name"=>"highlight hard"),
        array("value"=>"05_inset_soft.png","width"=>"1","height"=>"100","name"=>"inset soft"),
        array("value"=>"06_inset_hard.png","width"=>"1","height"=>"100","name"=>"inset hard"),
        array("value"=>"07_diagonals_small.png","width"=>"40","height"=>"40","name"=>"diagonals small"),
        array("value"=>"07bdiagonals_medium.png","width"=>"40","height"=>"40","name"=>"medium.png"),
        array("value"=>"08_diagonals_thick.png","width"=>"40","height"=>"40","name"=>"diagonals thick"),
        array("value"=>"09_dots_small.png","width"=>"2","height"=>"2","name"=>"dots small"),
        array("value"=>"10_dots_medium.png","width"=>"4","height"=>"4","name"=>"dots medium"),
        array("value"=>"11_white_lines.png","width"=>"40","height"=>"100","name"=>"white lines"),
        array("value"=>"12_gloss_wave.png","width"=>"500","height"=>"100","name"=>"gloss wave"),
        array("value"=>"13_diamond.png","width"=>"10","height"=>"8","name"=>"diamond"),
        array("value"=>"14_loop.png","width"=>"21","height"=>"21","name"=>"loop"),
        array("value"=>"15_carbon_fiber.png","width"=>"8","height"=>"9","name"=>"carbon fiber"),
        array("value"=>"16_diagonal_maze.png","width"=>"10","height"=>"10","name"=>"diagonal maze"),
        array("value"=>"17_diamond_ripple.png","width"=>"22","height"=>"22","name"=>"diamond ripple"),
        array("value"=>"18_hexagon.png","width"=>"12","height"=>"10","name"=>"hexagon"),
        array("value"=>"19_layered_circles.png","width"=>"13","height"=>"13","name"=>"layered circles"),
        array("value"=>"20_3D_boxes.png","width"=>"12","height"=>"10","name"=>"3D boxes"),
        array("value"=>"21_glow_ball.png","width"=>"16","height"=>"16","name"=>"glow ball"),
        array("value"=>"22_spotlight.png","width"=>"16","height"=>"16","name"=>"spotlight"),
        array("value"=>"23_fine_grain.png","width"=>"60","height"=>"60","name"=>"fine grain")
);
$themes = array_merge($themesdefault,$_GET);
$textures_hash = array();
...
function icon_src($color){
        global $icons;
        $markup = "phpThumb.php?new=".$color."&w=".$icons['width']."&h=".$icons['height']."&f=png&fltr[]=rcd|256&fltr[]=mask|icons/".$icons['value'];
        return $markup;
}

function texture_src($color,$name='color',$opacity=0){
        global $textures_hash;
        global $themes;
        $name = $themes[$name];
        preg_match('/^icon/i',$color,$out);
        if(count($out)){
        ...
        $markup = "phpThumb.php?new=".$color."&w=".$image["width"]."&h=".$image["height"]."&f=png&q=100&fltr[]=over|textures/".$image["value"]."|0|0|".$opacity;
        return $markup;
