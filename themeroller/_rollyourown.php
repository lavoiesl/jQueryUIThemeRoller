...
<form method="get" action="/" id="themeConfig">
   <fieldset class="clearfix">
      ...
      <div class="theme-group clearfix" id="global-font" style="display:none;">
      ...
      <div class="theme-group clearfix" id="Toolbar">
         <div class="theme-group-header state-default">
            <span class="icon icon-triangle-1-e">Collapse</span>
            <div class="state-preview corner-all ui-toolbar">abc</div>
            <a href="#">Toolbar</a>

         </div><!-- /theme group header -->
         <div class="theme-group-content corner-bottom clearfix">
            <div class="field-group field-group-background clearfix">
               <label for="bgColorToolbar" class="background">Background color &amp; texture</label>
               <input type="text" name="bgColorToolbar" id="bgColorToolbar" class="hex" value="<?php echo $themes["bgColorToolbar"]?>" />
               <?php echo texture_select("bgTextureToolbar",$themes["bgTextureToolbar"])?>

               <input type="text" name="bgImgOpacityToolbar" class="opacity" value="<?php echo $themes["bgImgOpacityToolbar"]?>" />
               <span class="opacity-per">%</span>

            </div>
            <div class="field-group field-group-border clearfix">
               <label for="borderColorToolbar">Border</label>
               <input type="text" name="borderColorToolbar" id="borderColorToolbar" class="hex" value="<?php echo $themes["borderColorToolbar"]?>" size="6" />
            </div>
            <div class="field-group clearfix">

               <label for="fcToolbar">Text</label>
               <input type="text" name="fcToolbar" id="fcToolbar" class="hex" value="<?php echo $themes["fcToolbar"]?>" size="6" />
            </div>
            <div class="field-group clearfix">

               <label for="lcToolbar">Link</label>
               <input type="text" name="lcToolbar" id="lcToolbar" class="hex" value="<?php echo $themes["lcToolbar"]?>" size="6" />
            </div>


            <div class="field-group clearfix">
               <label for="iconColorToolbar">Icon</label>
               <input type="text" name="iconColorToolbar" id="iconColorToolbar" class="hex" value="<?php echo $themes["iconColorToolbar"]?>" size="6" />
            </div>
         </div><!-- /theme group content -->

      </div><!-- /theme group -->			

      <div class="theme-group clearfix" id="Layout">
         <div class="theme-group-header state-default">
            <span class="icon icon-triangle-1-e">Collapse</span>
            <div class="state-preview corner-all ui-layout">abc</div>
            <a href="#">Layout/body</a>

         </div><!-- /theme group header -->
         <div class="theme-group-content corner-bottom clearfix">
            <div class="field-group field-group-background clearfix">
               <label for="bgColorLayout" class="background">Background color &amp; texture</label>
               <input type="text" name="bgColorLayout" id="bgColorLayout" class="hex" value="<?php echo $themes["bgColorLayout"]?>" />
               <?php echo texture_select("bgTextureLayout",$themes["bgTextureLayout"])?>

               <input type="text" name="bgImgOpacityLayout" class="opacity" value="<?php echo $themes["bgImgOpacityLayout"]?>" />
               <span class="opacity-per">%</span>

            </div>
            <div class="field-group field-group-border clearfix">
               <label for="borderColorLayout">Border</label>
               <input type="text" name="borderColorLayout" id="borderColorLayout" class="hex" value="<?php echo $themes["borderColorLayout"]?>" size="6" />
            </div>
            <div class="field-group clearfix">

               <label for="fcLayout">Text</label>
               <input type="text" name="fcLayout" id="fcLayout" class="hex" value="<?php echo $themes["fcLayout"]?>" size="6" />
            </div>
            <div class="field-group clearfix">

               <label for="lcLayout">Link</label>
               <input type="text" name="lcLayout" id="lcLayout" class="hex" value="<?php echo $themes["lcLayout"]?>" size="6" />
            </div>


            <div class="field-group clearfix">
               <label for="iconColorLayout">Icon</label>
               <input type="text" name="iconColorLayout" id="iconColorLayout" class="hex" value="<?php echo $themes["iconColorLayout"]?>" size="6" />
            </div>
         </div><!-- /theme group content -->
      ...
      <div class="theme-group clearfix" id="Header">
         ...
         <div class="theme-group-content corner-bottom clearfix">
            ...
            <div class="field-group clearfix">
               ...
               <label for="lcHeader">Link</label>
               <input type="text" name="lcHeader" id="lcHeader" class="hex" value="<?php echo $themes["lcHeader"]?>" size="6" />
            </div>
      ...
      <div class="theme-group clearfix" id="ContentArea">
         ...
         <div class="theme-group-content corner-bottom clearfix">
            ...
            <div class="field-group clearfix">
               ...
               <label for="lcContent">Link</label>
               <input type="text" name="lcContent" id="lcContent" class="hex" value="<?php echo $themes["lcContent"]?>" size="6" />
            </div>
      ...
      <div class="theme-group clearfix" id="Input">
         <div class="theme-group-header state-default">
            <span class="icon icon-triangle-1-e">Collapse</span>
            <div class="state-preview corner-all ui-input">abc</div>
            <a href="#">Input: text</a>

         </div><!-- /theme group Input -->
         <div class="theme-group-content corner-bottom clearfix">

            <div class="field-group field-group-background clearfix">
               <label for="bgColorInput" class="background">Background color &amp; texture</label>
               <input type="text" name="bgColorInput" id="bgColorInput" class="hex" value="<?php echo $themes["bgColorInput"]?>" />
               <?php echo texture_select("bgTextureInput",$themes["bgTextureInput"])?>

               <input type="text" name="bgImgOpacityInput" class="opacity" value="<?php echo $themes["bgImgOpacityInput"]?>" />
               <span class="opacity-per">%</span>
            </div>
            <div class="field-group field-group-border clearfix">
               <label for="borderColorInput">Border</label>
               <input type="text" name="borderColorInput" id="borderColorInput" class="hex" value="<?php echo $themes["borderColorInput"]?>" size="6" />
            </div>
            <div class="field-group clearfix">

               <label for="fcInput">Text</label>
               <input type="text" name="fcInput" id="fcInput" class="hex" value="<?php echo $themes["fcInput"]?>" size="6" />
               </div>
               <div class="field-group clearfix">
               <label for="iconColorInput">Icon</label>
               <input type="text" name="iconColorInput" id="iconColorInput" class="hex" value="<?php echo $themes["iconColorInput"]?>" size="6" />
            </div>
         </div><!-- /theme group content -->
      ...
      <div class="theme-group clearfix" id="Light">
         <div class="theme-group-header state-default">
            <span class="icon icon-triangle-1-e">Collapse</span>
            <div class="state-preview corner-all ui-state-light">abc</div>
            <a href="#">Light</a>

         </div><!-- /theme group Light -->
         <div class="theme-group-content corner-bottom clearfix">

            <div class="field-group field-group-background clearfix">
               <label for="bgColorLight" class="background">Background color &amp; texture</label>
               <input type="text" name="bgColorLight" id="bgColorLight" class="hex" value="<?php echo $themes["bgColorLight"]?>" />
               <?php echo texture_select("bgTextureLight",$themes["bgTextureLight"])?>

               <input type="text" name="bgImgOpacityLight" class="opacity" value="<?php echo $themes["bgImgOpacityLight"]?>" />
               <span class="opacity-per">%</span>

            </div>
            <div class="field-group field-group-border clearfix">
               <label for="borderColorLight">Border</label>
               <input type="text" name="borderColorLight" id="borderColorLight" class="hex" value="<?php echo $themes["borderColorLight"]?>" size="6" />
            </div>
            <div class="field-group clearfix">

               <label for="fcLight">Text</label>
               <input type="text" name="fcLight" id="fcLight" class="hex" value="<?php echo $themes["fcLight"]?>" size="6" />
            </div>
            <div class="field-group clearfix">

               <label for="lcLight">Link</label>
               <input type="text" name="lcLight" id="lcLight" class="hex" value="<?php echo $themes["lcLight"]?>" size="6" />
            </div>


            <div class="field-group clearfix">
               <label for="iconColorLight">Icon</label>
               <input type="text" name="iconColorLight" id="iconColorLight" class="hex" value="<?php echo $themes["iconColorLight"]?>" size="6" />
            </div>
         </div><!-- /theme group content -->
      ...
      <div class="theme-group clearfix" id="Highlight">
         ...
         <div class="theme-group-content corner-bottom clearfix">
            ...
            <div class="field-group clearfix">
               ...
               <label for="lcHighlight">Link</label>
               <input type="text" name="lcHighlight" id="lcHighlight" class="hex" value="<?php echo $themes["lcHighlight"]?>" size="6" />
            </div>
      ...
      <div class="theme-group clearfix" id="Error">
         ...
         <div class="theme-group-content corner-bottom clearfix">
            ...
            <div class="field-group clearfix">
               ...
               <label for="lcError">Link</label>
               <input type="text" name="lcError" id="lcError" class="hex" value="<?php echo $themes["lcError"]?>" size="6" />
            </div>
            <div class="field-group clearfix">
