...
var hash = {
	...
	refreshToHash: function(locStr) {
		...
		// reload tab
		$('#rollerTabsNav').tabs('url', 0, '_rollyourown.php?'+ locStr);
		$('#rollerTabsNav').tabs('load', 0);
...
function updateCSS(locStr){
	...
	$("link[href*=parseTheme.css.php]:last").after('<link href="parseTheme.css.php?'+ locStr +'" type="text/css" rel="Stylesheet" />');
...
function rollYourOwnBehaviors() {	
	...
	$('select.texture').each(function() {
		...
		$(this).find('option').each(function(){
			ul.append('<li class="'+ $(this).attr('value') +'" data-texturewidth="'+$(this).attr('data-texturewidth')+'" data-textureheight="'+$(this).attr('data-texturewidth')+'" style="background: #555555 url(images/?new=555555&w='+$(this).attr('data-texturewidth')+'&h='+$(this).attr('data-textureheight')+'&f=png&q=100&fltr[]=over|textures/'+$(this).attr('value')+'|0|0|100) 50% 50% repeat"><a href="#" title="'+ $(this).text() +'">'+ $(this).text() +'</a></li>');
			if($(this).get(0).index == sIndex){texturePicker.attr('title',$(this).text()).css('background', '#555555 url(images/?new=555555&w='+$(this).attr('data-texturewidth')+'&h='+$(this).attr('data-textureheight')+'&f=png&q=60&fltr[]=over|textures/'+$(this).attr('value')+'|0|0|100) 50% 50% repeat');}
		});
		
		ul.find('li').click(function() {
			texturePicker.prev().get(0).selectedIndex = texturePicker.prev().find('option[value='+ $(this).attr('class') +']').get(0).index;
			texturePicker.attr('title',$(this).text()).css('background', '#555555 url(images/?new=555555&w='+$(this).attr('data-texturewidth')+'&h='+$(this).attr('data-textureheight')+'&f=png&q=60&fltr[]=over|textures/'+$(this).attr('class')+'|0|0|100)  50% 50% repeat');
			//ul.fadeOut(100);
			formChange();
			return false;
		});
	...
	$('#downloadTheme').click(function(){
		...
		var straightToDownload = (bookmarklet) ? '&ui-version=1.6rc6&download=true' : '';
